                ...
                <div className="fare-details">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td className="bLeft">
                                    <input className='form-control' type="text" style={{width:'175px'}}
                                        onBlur={e => handleName(e)} placeholder="Name" />
                            ...
                            <tr>
                                <td className="bLeft">Total Charges</td>
                            ...
                            <tr>
                                <td className="bLeft">
                                    <button className="btn btn-success" disabled={!details.name || !details.gender}
                                        onClick={e => handlePayments(e)}>Continue to Payment</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
