            ...
            <div className="signin">
                <form onSubmit={e => handleSubmit(e)}>
                    <div className="form-group">
                        <input type="email" placeholder="Email" id="email" name="email" onBlur={e => handleEmail(e)} /><br />
                    ...
                    <button type="submit" disabled={!details.email || !details.password || data || pswd || error} className="btn btn-success">Sign In</button>
                    <span>{error}</span>
                </form>
            </div>
